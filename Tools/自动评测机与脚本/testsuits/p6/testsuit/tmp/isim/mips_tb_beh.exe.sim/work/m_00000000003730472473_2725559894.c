...
LAB65:    if (*((unsigned int *)t9) > 0)
        goto LAB66;

LAB67:    if (*((unsigned int *)t40) > 0)
        goto LAB68;

LAB69:    memcpy(t10, t22, 8);
...
LAB66:    xsi_vlog_unsigned_bit_combine(t10, 32, t21, 32, t22, 32);
    goto LAB70;

LAB68:    memcpy(t10, t21, 8);
    goto LAB70;
...
LAB85:    xsi_vlog_unsigned_bit_combine(t10, 32, t41, 32, t46, 32);
    goto LAB89;
